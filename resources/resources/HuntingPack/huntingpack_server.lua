...
local defaultLocation = '' -- change this if you want to store the ranks in a specific folder (ie.. C:\\Hunting Pack\\Ranks\\)
...
AddEventHandler('OnRequestedStart', function(startPoint)
    ...
    for _, playerId in ipairs(GetSpawnedPlayers()) do
        ...
        if count == driverIdx then
            ...
            maxTimeBelowSpeed = math.clamp(total_players * 2 , 6, 12)
